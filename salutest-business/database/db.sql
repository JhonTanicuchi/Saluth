INSERT INTO
  catalogos (nombre_catalogo, valor_catalogo)
VALUES
  ('categoria_institucion', 'Farmacia'),
  ('categoria_institucion', 'Centro Médico'),
  ('categoria_institucion', 'Clínica'),
  ('categoria_institucion', 'Hospital'),
  ('tipo_institucion', 'Pública'),
  ('tipo_institucion', 'Privada'),
  ('tipo_modulo', 'Público'),
  ('tipo_modulo', 'Privado');
INSERT INTO
  aplicacions (nombre_aplicacion)
VALUES
  ('Salutest Patient'),
  ('Salutest ERP'),
  ('Salutest Management'),
...
VALUES
  ...
  ('login_erp');
INSERT INTO
  rol_permisos (rolIdRol, permisoIdPermiso)
VALUES
  (
    (SELECT id_rol FROM rols WHERE nombre_rol = "Administrador Business"),
    (SELECT id_permiso FROM permisos WHERE nombre_permiso = "login_business")
  ),
  (
    (SELECT id_rol FROM rols WHERE nombre_rol = "Administrador"),
    (SELECT id_permiso FROM permisos WHERE nombre_permiso = "login_management")
  ),
  (
    (SELECT id_rol FROM rols WHERE nombre_rol = "Administrador"),
    (SELECT id_permiso FROM permisos WHERE nombre_permiso = "login_erp")
  ),(
    (SELECT id_rol FROM rols WHERE nombre_rol = "Empleado"),
    (SELECT id_permiso FROM permisos WHERE nombre_permiso = "login_erp")
  ),(
    (SELECT id_rol FROM rols WHERE nombre_rol = "Paciente"),
    (SELECT id_permiso FROM permisos WHERE nombre_permiso = "login_patient")
  );



/* 
INSERT INTO `modulo_catalogos` (`id_modulo_catalogo`, `creacionModulo_catalogo`, `actualizacionModulo_catalogo`, `catalogoIdCatalogo`, `moduloIdModulo`) VALUES (NULL, current_timestamp(), current_timestamp(), '7', '12'), (NULL, current_timestamp(), current_timestamp(), '7', '5'), (NULL, current_timestamp(), current_timestamp(), '7', '14'), (NULL, current_timestamp(), current_timestamp(), '7', '16'), (NULL, current_timestamp(), current_timestamp(), '7', '15'), (NULL, current_timestamp(), current_timestamp(), '7', '9'), (NULL, current_timestamp(), current_timestamp(), '7', '17'), (NULL, current_timestamp(), current_timestamp(), '7', '4'), (NULL, current_timestamp(), current_timestamp(), '7', '8'), (NULL, current_timestamp(), current_timestamp(), '7', '2'), (NULL, current_timestamp(), current_timestamp(), '7', '11'), (NULL, current_timestamp(), current_timestamp(), '7', '13'), (NULL, current_timestamp(), current_timestamp(), '7', '3'), (NULL, current_timestamp(), current_timestamp(), '7', '7'), (NULL, current_timestamp(), current_timestamp(), '7', '6'), (NULL, current_timestamp(), current_timestamp(), '7', '10'); */
