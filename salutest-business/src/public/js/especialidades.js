...
function InsertarDatos(data) {
    ...
    columna1 = Fila.insertCell(0).innerHTML = data.especialidad
    columna2 = Fila.insertCell(1).innerHTML = data.descripcion
    columna3 = Fila.insertCell(2).innerHTML = data.fecha_creacion
    columna4 = Fila.insertCell(3).innerHTML = data.estado
