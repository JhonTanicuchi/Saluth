...
VALUES
    ...
    ('categoria_modulo', 'Administración'),
    ('categoria_modulo', 'Panel de control'),
    ('tipo_modulo', 'Público'),
    ('tipo_modulo', 'Privado');
    ...
    (
        ...
        'envelope',(
            ...
            FROM
                aplicacions
            WHERE
                nombre_aplicacion = "Saluth Business"
        )
    ),
    (
        'Instituciones',
...
INSERT INTO
    modulo_catalogo(moduloIdModulo, catalogoIdCatalogo)
VALUES
    (
        (
            SELECT
            ...
            FROM
                catalogos
            WHERE
                nombre_catalogo = "categoria_modulo"
                AND valor_catalogo = 'Administración'
        )
    ),
    (
        (
    ...
    (
        (
            ...
            WHERE
                nombre_catalogo = "categoria_modulo"
                AND valor_catalogo = 'Panel de control'
        )
    ),
    (
        (
        ...
        (
            ...
            FROM
                catalogos
            WHERE
                nombre_catalogo = "tipo_modulo "
                AND valor_catalogo = 'Público'
        )
    ),
    (
        (
...
VALUES(
        'admin_saluth',
        '$2a$10$bLoPMbtf5TYXPQPMFiXajus1VK18vk2Ll1O.js1.ZyO6Iw9glE0fe',
        'saluth@gmail.com',(
            SELECT
                e.id_empleado_business
            FROM
                empleado_businesses e
                JOIN personas p ON p.id_persona = e.personaIdPersona
            where
                p.cedula_persona = '0110000100'
        ),(
            SELECT
                id_rol
            FROM
