...
user_admin.new_user = async () => {
  ...
  if (usuario_Admin.length != 0) {
    ...
    await sql.query(
      "INSERT INTO personas (cedula_persona,nombres_persona,apellidos_persona,fecha_nacimiento_persona,direccion_persona)VALUES('0110000100','Admin','Saluth','01/07/2019','Saluth')"
    );
    await sql.query(
      "INSERT INTO empleado_businesses (personaIdPersona) VALUES ((SELECT id_persona FROM personas where cedula_persona = '0110000100'))"
    );
    await sql.query(
      "INSERT INTO usuario_businesses (username,password,correo,empleadoBusinessIdEmpleadoBusiness,rolIdRol)VALUES('admin_salutest','$2a$10$bLoPMbtf5TYXPQPMFiXajus1VK18vk2Ll1O.js1.ZyO6Iw9glE0fe','saluth@gmail.com',(SELECT e.id_empleado_business FROM empleado_businesses e JOIN personas p ON p.id_persona = e.personaIdPersona where p.cedula_persona = '0110000100'),(SELECT id_rol FROM rols WHERE nombre_rol = 'Administrador'))"
    );
